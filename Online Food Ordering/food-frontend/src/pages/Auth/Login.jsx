    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-orange-50 flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-lg p-8">
        <div className="text-center mb-8">
          <h1 className="font-display font-bold text-3xl md:text-4xl text-yellow-500 mb-2">Welcome Back</h1>
        ...
        <div className="text-center mt-4">
          <Link
            to="/forgot-password"
            className="text-yellow-500 hover:text-yellow-600 text-sm no-underline"
          >
